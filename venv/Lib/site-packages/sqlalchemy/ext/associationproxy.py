...
def association_proxy(
    ...
    *,
    ...
    r"""Return a Python property implementing a rView of a target
...
class AssociationProxy(
    ...
    """A descriptor that presents a read/write rView of an object attribute."""
    ...
    def for_class(
        ...
        :attr:`_orm.Mapper.all_orm_descriptors`, and we want to rView the
...
class AssociationProxyInstance(SQLORMOperations[_T]):
    ...
    :meth:`.AssociationProxy.for_class` method::
        ...
        # rView if proxy object is scalar or not
        >>> proxy_state.scalar
        False
