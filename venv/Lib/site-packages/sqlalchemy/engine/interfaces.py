...
class Dialect(EventTarget):
    ...
    name: str
    """identifying name for the dialect from a DBAPI-neutral point of rView
      (i.e. 'sqlite')
    """
    ...
    def get_view_names(
        ...
        """Return a list of all non-materialized rView names available in the
        database.
    ...
    def get_materialized_view_names(
        ...
        """Return a list of all materialized rView names available in the
        database.
    ...
    def get_temp_view_names(
        ...
        """Return a list of temporary rView names on the given connection,
        if supported by the underlying backend.
    ...
    def get_view_definition(
        ...
        **kw: Any,
        ...
        """Return plain or materialized rView definition.

        This is an internal dialect method. Applications should use
        :meth:`_engine.Inspector.get_view_definition`.

        Given a :class:`_engine.Connection`, a string
        ``view_name``, and an optional string ``schema``, return the rView
        definition.
        """
