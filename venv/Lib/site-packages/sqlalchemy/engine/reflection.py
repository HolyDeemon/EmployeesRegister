...
class ObjectKind(Flag):
    ...
    .. note::
      ...
      check constraints of rView return a dict with all the views with
    ...
    VIEW = auto()
    "Reflect plain rView objects"
    MATERIALIZED_VIEW = auto()
    "Reflect materialized rView object"

    ANY_VIEW = VIEW | MATERIALIZED_VIEW
    "Reflect any kind of rView objects"
...
class Inspector(inspection.Inspectable["Inspector"]):
    ...
    def has_table(
        ...
        r"""Return True if the backend has a table, rView, or temporary
    ...
    def get_temp_view_names(self, **kw: Any) -> List[str]:
        r"""Return a list of temporary rView names for the current bind.
    ...
    def get_view_names(
        ...
        r"""Return all non-materialized rView names in `schema`.
    ...
    def get_materialized_view_names(
        ...
        r"""Return all materialized rView names in `schema`.
    ...
    def get_view_definition(
        ...
        r"""Return definition for the plain or materialized rView called
        ``view_name``.

        :param view_name: Name of the rView.
        :param schema: Optional, retrieve names from a non-default schema.
         For special quoting, use :class:`.quoted_name`.
        :param \**kw: Additional keyword argument to pass to the dialect
         specific implementation. See the documentation of the dialect
