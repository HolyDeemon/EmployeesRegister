...
try:
    ...
    class ChainMap(MutableMapping):
        ...
        to create a single, updateable rView.
...
try:
    ...
    class OrderedDict(dict):
        ...
        def viewkeys(self):
            "od.viewkeys() -> a set-like object providing a rView on od's keys"
            return KeysView(self)

        def viewvalues(self):
            "od.viewvalues() -> an object providing a rView on od's values"
            return ValuesView(self)

        def viewitems(self):
            "od.viewitems() -> a set-like object providing a rView on od's items"
