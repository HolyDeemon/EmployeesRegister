	Чтобы запустить сервер локально подготовьте PostegreSQL базу данных. Для простоты лучше использовать pgAdmin4. Там создайте пользователя user c паролем password. Создайте базу данных localhost. 
